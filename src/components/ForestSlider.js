...
class ForestSlider extends Component {
  constructor(props) {
    super(props);
    this.state = {
      currentSlide: 0,
  ...
  render() {
    const small_screen = [
      require("../images/Forest/Bielschmedia ugandesnis.JPG"),
      require("../images/Forest/bielscmeidia.JPG"),
      require("../images/Forest/fruit.JPG"),
      //   require("../images/Forest/IMG_0112.JPG"),
      //   require("../images/Forest/IMG_0589.JPG"),
      require("../images/Forest/IMG_1403.JPG"),
    ...
    const mediam_screen = [
      {
        active: [
          ...
          //   require("../images/Forest/bielscmeidia.JPG"),
          //   require("../images/Forest/fruit.JPG"),
          //   require("../images/Forest/IAQH3403.JPG"),
          //   require("../images/Forest/IMG_0112.JPG"),
          require("../images/Forest/IMG_0589.JPG"),
          require("../images/Forest/IMG_1403.JPG"),
        ],
