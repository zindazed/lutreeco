...
class CommunitySlider extends Component {
  ...
  render() {
    const small_screen = [
      ...
      require("../images/community/Local community involvement.JPG"),
    ...
    const mediam_screen = [
      ...
      {
        others_1: [
          require("../images/community/IMG_2021.JPG"),
          require("../images/community/IMG_3007.JPG"),
        ],
      },
      {
        others_2: [
          require("../images/community/IMG_3351.JPG"),
          require("../images/community/IMG_9493.JPG"),
        ],
      },
      {
        others_3: [
          require("../images/community/Local community involvement.JPG"),
          require("../images/community/Local people involvement.jpeg"),
        ],
      },
    ];
