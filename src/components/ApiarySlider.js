...
class ApiarySlider extends Component {
  constructor(props) {
    super(props);
    this.state = {
      currentSlide: 0,
  ...
  render() {
    const small_screen = [
      ...
      //   require("../images/apiary/IMG_1278.JPG"),
      ...
      //   require("../images/apiary/IMG_1669.JPG"),
      //   require("../images/apiary/IMG_3035.JPG"),
      require("../images/apiary/IMG_3288.JPG"),
      //   require("../images/apiary/IMG_8240.PNG"),
      //   require("../images/apiary/IMG_8256.PNG"),
    ];
